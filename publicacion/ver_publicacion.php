			...
			<div class="panel-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select class="form-control" id="idciudad" name="idciudad" data-trigger="focus" data-container="body" data-toggle="popover" data-placement="right" data-content="Seleccione tipo de publicaci&oacute;n.">
