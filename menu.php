...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <label class="navbar-brand"><img src="img/LogoVenAyuda_SM.png" width="90px" height="50px" style="margin-top: -11px;margin-left: 10px;"></label>
	    </div>

		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		    <ul class="nav navbar-nav">
		    	<li><a href="#">Hacer donaci&oacute;n</a></li>
				<li class="dropdown">
		...
		<div id="modal-sesion" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
				...
				<div id="msj_alert" name="msj_alert" style="display:none;width:40%;margin:0 auto;"></div>
				</div>
				</div> <!--Body-->
		    	<div class="modal-footer" style="text-align:center;">
	...
	function validar_log()
	{
		...
		$.post("login.php",{data : JSON.stringify({"user_login": user_login,"pass_login": pass_login})},function(resp,status){
			...
			if(json.respuesta==true){
				...
				$("#msj_alert").show("fast");
				setTimeout(function(){$("#msj_alert").hide("fast"); $("#msj_alert").html(""); window.location.reload();},5000);
			}
			else
			{
